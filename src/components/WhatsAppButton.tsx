  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-4 items-center">
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.9 }}
        className="w-14 h-14 btn-premium rounded-full flex items-center justify-center shadow-2xl hover:shadow-gold transition-all duration-300 border-2 border-white/20"
